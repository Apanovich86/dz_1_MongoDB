...
db.getCollection('rest').find({grades : { $elemMatch:{"score":{$gt : 80 , $lt :100}}}});
...
db.getCollection('rest').find({name: /^Wil/},{"restaurant_id" : 1,"name":1,"borough":1,"cuisine" :1});
...
db.getCollection('rest').find({$or :[{"borough" :"Staten Island"},{"borough" :"Queens"},{"borough" :"Bronx"},{"borough" :"Brooklyn"}]},{
                        "restaurant_id" : 1,
                        "name":1,
                        "borough":1,
                        "cuisine" :1});
...
db.getCollection('rest').find({"borough" :{$nin :["Staten Island","Queens","Bronx","Brooklyn"]}},{
                              "restaurant_id" : 1,"name":1,"borough":1,"cuisine" :1});
...
db.getCollection('rest').find({"grades.score" : {$mod : [7,0]}}, {"restaurant_id" : 1,"name":1,"grades":1});

//31. Write a MongoDB query to find the restaurant name, borough, longitude and attitude and cuisine for those restaurants which contains 'mon' as three letters somewhere in its name.
db.getCollection('rest').find({ name : 
                     { $regex : "mon.*", $options: "i"}},{
                         "name":1,
                         "borough":1,
                         "address.coord":1,
